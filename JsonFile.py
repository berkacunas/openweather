...
from City import City, CityNotFoundError
...
class JsonFile:
	...
	def __init__(self, json_file_path = None):
		...
		if json_file_path:
			...
			self.json_file_path = self.config.get('OpenWeather.Resources.Json', 'CityList')

		self.raw_data_directory = self.config.get('Directories', 'RawDataDirectory')
