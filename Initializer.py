...
class Initializer:
	...
	def init(self, cwd):
		...
		self.config_wrapper.set('Data', 'UserCityFile', os.path.join(self.cwd, 'data', 'user_city.json'))
		self.config_wrapper.set('Data', 'UserDataFile', os.path.join(self.cwd, 'data', 'user_data.json'))
